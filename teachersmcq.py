...
# # API configuration
# os.environ["GOOGLE_API_KEY"] = 'AIzaSyDm6F53eEwAeqJeMviIMh6My9uNslO8WjU'
...
#                         st.markdown(f"<span style='color: green; font-weight: bold;'>{line.strip()}</span>", unsafe_allow_html=True)
#                 st.markdown("---")
